...
public class MixinEntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onLivingUpdate() {
        ...
        if (this.inPortal) {
            ...
            this.inPortal = false;
        } else if (this.isPotionActive(Potion.confusion) && this.getActivePotionEffect(Potion.confusion).getDuration() > 60 && (!Access.Instance.getModule("Anti Debuff").getVal("Effect").equals("Blindness") && !Access.Instance.getModule("Anti Debuff").enabled)) {
